...
<div class="wrap">
    ...
    <form name="data_list" method="post" class="js-ajax-form" novalidate="novalidate">
        ...
        <table class="table table-hover table-bordered">
          ...
          <tbody>
            <?php $__FOR_START_16013__=0;$__FOR_END_16013__=count($data_list);for($i=$__FOR_START_16013__;$i < $__FOR_END_16013__;$i+=1){ ?><tr>
                    ...
                    <td>
                      ...
                      |<a href="javascript:;" onclick='del_article(<?php echo ($data_list[$i]['id']); ?>,$(this))' class="js-ajax-delete">删除</a>
                    </td>
                </tr><?php } ?>
