...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('/Admin/index/collegeMajorAdd');?>" >添加本周行程</a></li>
			<li><a href="<?php echo U('/Admin/index/collegeMajorNextAdd');?>" >添加下周行程</a></li>

		</ul>
		<form id="add_index_menu" name="edit_college" action="<?php echo U('/Admin/College/ajaxAddMajor');?>" method="post" class="form-horizontal js-ajax-form" novalidate="novalidate">
			<fieldset>
...
<script type="text/javascript" src="/Public/admin/js/ajaxpost_college.js?v=2019098909"></script>
</body>
</html>