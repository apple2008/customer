            ...
            <div class="table_full">
              <span>用户&nbsp;<?php echo ($admin_user_info['user']); ?>&nbsp;|&nbsp;<?php echo ($admin_user_info['user_name']); ?>&nbsp;权限设置</span>
                ...
                <table class="table table-bordered treeTable" id="authrule-tree">
                    <tbody>
                    <?php $__FOR_START_32041__=0;$__FOR_END_32041__=count($admin_menu);for($i=$__FOR_START_32041__;$i < $__FOR_END_32041__;$i+=1){ ?><tr id="node-1" style="" class="initialized parent expanded">
                        ...
                        <?php $__FOR_START_30894__=0;$__FOR_END_30894__=count($admin_menu[$i]['one']);for($j=$__FOR_START_30894__;$j < $__FOR_END_30894__;$j+=1){ ?><tr id="node-2" class="child-of-node-1 initialized parent expanded index<?php echo ($i); ?>" style="">
                            ...
                            <?php $__FOR_START_5711__=0;$__FOR_END_5711__=count($admin_menu[$i]['one'][$j]['sec']);for($o=$__FOR_START_5711__;$o < $__FOR_END_5711__;$o+=1){ ?><tr id="node-3" class="child-of-node-2 parent initialized sec<?php echo ($i); echo ($j); ?>" style="">
