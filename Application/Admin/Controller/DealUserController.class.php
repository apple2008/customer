...
class DealUserController extends Controller {
    //通过传递过来的用户名和密码进行验证
    ...
    public function getSchoolList($page_up,$page_num,$area_id='',$name='',$business='',$admin_id='')
    {
        $admin_id && $data["s.admin_id"]=$admin_id;
