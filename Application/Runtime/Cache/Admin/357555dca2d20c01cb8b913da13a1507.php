...
<div class="wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo U('/Admin/index/trainRoomManage');?>">教室管理</a></li>
        <li><a href="<?php echo U('/Admin/index/trainRoomAdd');?>" >添加教室</a></li>
    </ul>
    <form name="data_list" method="post" class="js-ajax-form" novalidate="novalidate">
        ...
        <table class="table table-hover table-bordered">
          ...
          <tbody>
            <?php $__FOR_START_11496__=0;$__FOR_END_11496__=count($data_list);for($i=$__FOR_START_11496__;$i < $__FOR_END_11496__;$i+=1){ ?><tr>
