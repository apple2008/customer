...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link href="/Public/admin/css/admin_login.css?v=2020" rel="stylesheet">
...
<video id="example_video" loop="loop" preload="preload" height="auto" autoplay="" width="auto" style="position: absolute;right: 0;bottom: 0; margin: 0px; z-index: -1;min-width: 100%;min-height: 100%">
             <!--     <source src="/Public/common/video/background.mp4" type='video/mp4' />-->
                  <source src="http://oh31kniww.bkt.clouddn.com/eee.webm" type='video/webm' />
        </video>
		...
		<form id="login" method="post" name="login" autocomplete="off" class="js-ajax-form" novalidate="novalidate">
			<div class="login">
				<ul>
					...
					<!-- <li>
						<input class="input" id="admin_token" type="password" name="token" placeholder="密令" title="密令" data-rule-required="true" data-msg-required="" aria-required="true">
					</li> -->
