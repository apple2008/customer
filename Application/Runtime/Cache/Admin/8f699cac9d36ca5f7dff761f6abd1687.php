...
<div class="wrap js-check-wrap">
	...
	<form name="sel_quest" class="well form-search" action="<?php echo U('/Admin/index/questManage');?>" method="post">
		...
		<select name="term" style="width: 200px;">
		   ...
		   <?php $__FOR_START_14756__=0;$__FOR_END_14756__=count($quest_nav_list);for($i=$__FOR_START_14756__;$i < $__FOR_END_14756__;$i+=1){ ?><option value="<?php echo ($quest_nav_list[$i]['id']); ?>"><?php echo ($quest_nav_list[$i]['nav_name']); ?></option><?php } ?>
	...
	<form name="quest_list" class="js-ajax-form" novalidate="novalidate">
		...
		<table class="table table-hover table-bordered table-list">
			...
			<tbody>
			  <?php $__FOR_START_13069__=0;$__FOR_END_13069__=count($quest_list);for($i=$__FOR_START_13069__;$i < $__FOR_END_13069__;$i+=1){ ?><tr>
				   <td>
