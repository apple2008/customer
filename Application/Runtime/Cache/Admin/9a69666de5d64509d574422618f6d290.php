	...
	<div class="wrap js-check-wrap">
		...
		<form class="well form-search" id="mainform" action="" method="post">
			<select id="navcid_select" name="cid">
			  <?php $__FOR_START_22059__=0;$__FOR_END_22059__=count($adv_menu);for($i=$__FOR_START_22059__;$i < $__FOR_END_22059__;$i+=1){ if($adv_menu[$i]['id'] == $cid): ?><option value="<?php echo ($adv_menu[$i]['id']); ?>" selected=""><?php echo ($adv_menu[$i]['menu_name']); ?></option>
			  	 <?php else: ?>
		...
		<form class="js-ajax-form" action="" method="post" novalidate="novalidate">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<tbody>
				  ...
				  <?php $__FOR_START_31368__=0;$__FOR_END_31368__=count($index_menu_list);for($i=$__FOR_START_31368__;$i < $__FOR_END_31368__;$i+=1){ ?><tr>
						<td>
